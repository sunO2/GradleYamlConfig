...
gradlePlugin {
    // Define the plugin
    val yamlSettings by plugins.creating {
        id = "com.hezhihu89.yamlSettings"
        implementationClass = "com.hezhihu89.settings.YamlSettingsPlugin"
    }

    val yamlConfig by plugins.creating {
        id = "com.hezhihu89.yamlConfig"
